...
namespace U5ki.CfgService
{
    ...
    /// 
    /// </summary>
    public class CfgService_old : BaseCode/*, IService*/
    {
        /// <summary>
        /// 
        /// </summary>
        public CfgService_old()
        {
        }
            ...
            switch (cmd)
            {
                case ServiceCommands.LoadDefaultCfg:
                    ...
                    else if (File.Exists(DefaultCfgFile(spar)))
                    {
                        ...
                        LogInfo<CfgService_old>("Activada configuración " + spar, U5kiIncidencias.U5kiIncidencia.IGRL_U5KI_NBX_INFO,
                ...
                case ServiceCommands.SetDefaultCfg:
                    ...
                    else if (_LastCfg != null)
                    {
                        ...
                        LogInfo<CfgService_old>("Generada configuración " + spar + " por defecto...", U5kiIncidencias.U5kiIncidencia.IGRL_U5KI_NBX_INFO,
                ...
                case ServiceCommands.DelDefaultCfg:
                    ...
                    else if (File.Exists(file_name))
                    {
                        ...
                        LogInfo<CfgService_old>("Configuración " + spar + " eliminada...", U5kiIncidencias.U5kiIncidencia.IGRL_U5KI_NBX_INFO,
        ...
        public void Start()
        {
            try
            {
                ...
                LogInfo<CfgService_old>("Iniciando Servicio...");
                ExceptionManageInit();
                ...
                LogInfo<CfgService_old>("Servicio iniciado.", U5kiIncidencias.U5kiIncidencia.IGRL_U5KI_NBX_INFO, "CfgService", CTranslate.translateResource("Servicio iniciado."));
            }
#if _LOCKING_
			}
#endif
            catch (Exception ex)
            {
                ...
                ExceptionManage<CfgService_old>("Start", ex, "En START. Excepcion: " + ex.Message);
        ...
        public void Stop()
        {
            LogInfo<CfgService_old>("Iniciando parada servicio Configuracion.");
#if _LOCKING_
            lock (_lock)
            {
...
#endif
            LogInfo<CfgService_old>("Servicio detenido.", U5kiIncidencias.U5kiIncidencia.IGRL_U5KI_NBX_INFO, "CfgService", CTranslate.translateResource("Servicio detenido."));
        }
        ...
        private void OnChannelError(object sender, string error)
        {
            ...
            {
                LogError<CfgService_old>("OnChannelError: " + error);
            ...
            _WorkingThread.Enqueue("OnMasterStatusChanged", delegate ()
            {
                ...
                if (_Master)
                {
                    ...
                    catch (Exception x)
                    {
                        ...
                        ExceptionManage<CfgService_old>("OnMasterStatusChangedMaster", x, "Cambiando a MASTER. Excepcion: " + x.Message);
                    }
                    finally
                    {
                        LogInfo<CfgService_old>("MASTER", U5kiIncidencias.U5kiIncidencia.IGRL_U5KI_NBX_INFO, "CfgService", "MASTER");
                ...
                else
                {
                    ...
                    catch (Exception x)
                    {
                        ...
                        ExceptionManage<CfgService_old>("OnMasterStatusChangedSlave", x, "Cambiando a SLAVE. Excepcion: " + x.Message);
                    }
                    finally
                    {
                        _CheckCfg.Enabled = false;
            ...
            if (e.Content != null)
            {
                _WorkingThread.Enqueue("OnResourceChanged", delegate ()
                {
                    ...
                    if (!_Master)
                    {
                        ...
                        {
                            ExceptionManage<CfgService_old>("OnResourceChanged", exc, "Slave save cfg to file " + _LastCfg.Version + " Excepción: " + exc.Message);
                        }
                    }
#if _LOCKING_
                    }
        ...
        private void OnCheckCfg(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            {
                LogTrace<CfgService_old>("OnTimeElapsed-IN");
#if _LOCKING_
                lock (_lock)
                {
#endif
                if (_Master)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        _CheckCfg.Enabled = true;
                        ExceptionManage<CfgService_old>("OnTimeElapsed", ex, "En conexion SOAP. Exception: " + ex.Message);
                    }
                    finally
                    {
                        LogTrace<CfgService_old>("OnTimeElapsed-OUT");
                    }
                }
#if _LOCKING_
                }
                ...
                if (_Master && (dg.Data.Length > 0))
                {
                        ...
                        Settings.Default.ConfigByte.Length == 0)
                    {
                        if (dg.Data[1] >= 0x30)
                        {
                            ...
                            LogInfo<CfgService_old>("OnSoapCfgChanged: " + "Recibida notificacion de cambio de configuracion SOAP");
                            if (_CfgOnGoing == true)
                                _StopCfgThread = true;
                            _CheckCfg.Stop();
        ...
        private void TryGetSoapCfg()
        {
            try
            {
                ...
                LogTrace<CfgService_old>("TryGetSoapCfg: " + "Chequeando configuración SOAP. SystemId: " + systemId);
                ...
                using (SoapCfg.InterfazSOAPConfiguracion soapSrv = new U5ki.CfgService.SoapCfg.InterfazSOAPConfiguracion())
                {
                    ...
                    {
                        LogTrace<CfgService_old>("TryGetSoapCfg: " + "Configuración actual coincide con configuración SOAP");
                        return;
                    }
                    ...
                    {
                        ExceptionManage<CfgService_old>("TryGetSoapCfg", exc, "En TryGetSoapCfg save to file " + cfg.Version + " Excepción: " + exc.Message);
                    }
                    /**
                     * Fin de Modificacion */
                    ...
                    _WorkingThread.Enqueue("PublishNewCfg", delegate ()
                    {
                        try
                        {
                            ...
                            {
                                _LastCfg = cfg;
                                LogInfo<CfgService_old>("Publicando nueva configuración: " + cfg.Version, U5kiIncidencias.U5kiIncidencia.IGRL_U5KI_NBX_INFO,
                        ...
                        catch (Exception ex)
                        {
                            ...
                            ExceptionManage<CfgService_old>("TryGetSoapCfg", ex, "En TryGetSoapCfg. Excepcion: " + ex.Message + ". publicando configuracion " + cfg.Version);
            ...
            {
                Thread.ResetAbort();
                ExceptionManage<CfgService_old>("TryGetSoapCfg", ex, "En TryGetSoapCfg Excepcion: " + ex.Message);
            }
            catch (Exception ex)
            {
            ...
            if (msg.Type == Identifiers.CFG_SAVE_AS_DEFAULT_MSG)
            {
                if (_Master == false)
                {
                    if (_LastCfg != null)
                    {
                        ...
                        {
                            Serializer.Serialize(file, _LastCfg);
                            LogInfo<CfgService_old>("Generada configuracion por defecto", U5kiIncidencias.U5kiIncidencia.IGRL_U5KI_NBX_INFO,
                                "CfgService", CTranslate.translateResource("Generada configuracion por defecto"));
                        }
                    }
                    else
                    {
                        LogError<CfgService_old>(CTranslate.translateResource("No tengo configuración válida"),
