...
namespace HMI.CD40.Module
{
	public class ModuleController : WorkItemController
	{
		public override void Run()
		{
			...
			{
				((CmdManagerService)WorkItem.RootWorkItem.Services.Get<IEngineCmdManagerService>()).Run();
			};
			WorkItem.RootWorkItem.Terminated += delegate(object sender, EventArgs e) 
			{
				((CmdManagerService)WorkItem.RootWorkItem.Services.Get<IEngineCmdManagerService>()).Stop();
			};
		}
		...
		private void AddServices()
		{
			...
			WorkItem.RootWorkItem.Services.AddNew<CmdManagerService, IEngineCmdManagerService>();
		}
