...
namespace HMI.Presentation.Urr.Views
{
    ...
    public partial class ScreenSaverView : UserControl
    {
        ...
        {
            get { return _StateManager.Engine.Operative ? Resources.TlfBlank : Resources.TlfBlank; }
            //get { return _StateManager.Engine.Operative ? Resources.TlfOk : Resources.TlfNoOk; }//Quitar telefonia
        }
        ...
        private string _versionHmi
        {
            get
            {
                return typeof(ScreenSaverView).Assembly.GetName().Version.ToString();
            }
        }
