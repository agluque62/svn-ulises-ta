    ...
    public partial class RadioView : UserControl
    {
        ...
        public void OnRtxChanged(object sender, EventArgs e)
        {
            if (_StateManager.Radio.Rtx > 0)
            {
                ...
                _RtxBT.ButtonColor = _RtxBlinkOn ? HMI.Presentation.Urr.UI.VisualStyle.Colors.Yellow : HMI.Presentation.Urr.UI.VisualStyle.ButtonColor;
            ...
            else
            {
                ...
                _RtxBlinkOn = true;
                _RtxBT.Text = "Rtx";
                _RtxBT.ButtonColor = HMI.Presentation.Urr.UI.VisualStyle.ButtonColor;
            }
        ...
        private void Reset(UrrRdButton bt, RdDst dst)
        {
            ...
            if (dst.IsConfigurated)
            {
                ...
                if (!dst.Unavailable)
                {
                    ...
                    {
                        allAsOneBt = true;
                        title = _RtxBlinkOn ? HMI.Presentation.Urr.UI.VisualStyle.Colors.Yellow : HMI.Presentation.Urr.UI.VisualStyle.ButtonColor;
                        _RtxBlinkList[bt] = HMI.Presentation.Urr.UI.VisualStyle.Colors.Yellow;
                        //alias = (dst.TempAlias != string.Empty && dst.TempAlias != dst.Alias) ? dst.TempAlias : alias;
                    }
                    else if (dst.Rx)
                    {
                        rx = HMI.Presentation.Urr.UI.VisualStyle.Colors.White;

                        rxForeColor = HMI.Presentation.Urr.UI.VisualStyle.Colors.Green;
                        ...
                        if (dst.Tx)
                        {
                            ...
                            if (_StateManager.Radio.Rtx > 0)
                            {
                                ...
                                {
                                    allAsOneBt = true;
                                    title = _RtxBlinkOn ? HMI.Presentation.Urr.UI.VisualStyle.Colors.Yellow : bt.CurrentBackColor;
                                    _RtxBlinkList[bt] = HMI.Presentation.Urr.UI.VisualStyle.Colors.Yellow;
                                }
                                else if (rtxGroup == _StateManager.Radio.Rtx)
                                {
                                    allAsOneBt = true;
                                    title = HMI.Presentation.Urr.UI.VisualStyle.Colors.Yellow;
                                }
                            }
                        }
                        else
