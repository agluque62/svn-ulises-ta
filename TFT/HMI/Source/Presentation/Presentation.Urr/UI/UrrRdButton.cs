...
namespace HMI.Model.Module.UI
{
	public class UrrRdButton : Control
	{
		...
		public UrrRdButton()
		{
            ...
            _TxBtnInfo.SetForeColor(BtnState.Normal, Color.White);
			_RxBtnInfo.Text = "Rx";
            _RxBtnInfo.Font = _UrrBigFont;
            _RxBtnInfo.SetForeColor(BtnState.Normal, Color.White);
		}
...
//            BackColor = titleForeColor;
            ...
            _BtnInfo.SetBackColor(BtnState.Normal, (title == VisualStyle.Colors.Yellow || title == VisualStyle.Colors.Red) ? title : _CurrentBackColor);
