...
{
    public class IncreaseButton : System.Windows.Forms.Button
    {
        ...
        {
            get { return _UpBtnInfo.GetBackColor(BtnState.Inactive); }
            set
            {
                _UpBtnInfo.SetBackColor(BtnState.Inactive, value);
                Invalidate();
            }
        }

        //A veces se pinta de negro todo el boton.
        // Por tanto se mete el color directamente aquí
        public Color StartColor
        {
            get { return color1; }
            set { color1 = System.Drawing.Color.WhiteSmoke; Invalidate(); }
        }
        public Color EndColor
        {
            get { return color2; }
            set { color2 = System.Drawing.Color.LightGray; Invalidate(); }
        }
        ...
        public IncreaseButton()
        {
            ...
            this.StartColor = System.Drawing.Color.WhiteSmoke;
            this.EndColor = System.Drawing.Color.LightGray;
