...
namespace HMI.Presentation.Urr
{
    public class ModuleController : WorkItemController
    {
        ...
        {
            Color color = _StateManager.Scv.Active == -1 ? HMI.Presentation.Urr.UI.VisualStyle.UnknownScv :
                _StateManager.Scv.Active == 0 ? HMI.Presentation.Urr.UI.VisualStyle.ScvA : HMI.Presentation.Urr.UI.VisualStyle.ScvB;
