...
using HMI.Presentation.AUrr.Views;
...
namespace HMI.Presentation.AUrr
{
    public class ModuleController : WorkItemController
    {
        ...
        {
            Color color = _StateManager.Scv.Active == -1 ? HMI.Presentation.AUrr.UI.VisualStyle.UnknownScv :
                _StateManager.Scv.Active == 0 ? HMI.Presentation.AUrr.UI.VisualStyle.ScvA : HMI.Presentation.AUrr.UI.VisualStyle.ScvB;
