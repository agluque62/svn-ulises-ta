    ...
    public partial class TlfIaView : UserControl
    {
        ...
        */
        ...
        private void ShowAgenda(bool show)
        {
            ...
            {
                _Mem.Reset();
                _MemBT.ButtonColor = HMI.Presentation.AUrr.UI.VisualStyle.Colors.Yellow;
                _WorkItem.Workspaces[WorkspaceNames.IaToolsWorkspace].Show(_Mem);
            }
            else if (!show && !keypadShowed)
            {
                _MemBT.ButtonColor = HMI.Presentation.AUrr.UI.VisualStyle.ButtonColor;
        ...
        private void _SlowBlinkTimer_Tick(object sender, EventArgs e)
        {
            try
            {
                if (_SlowBlinkTimer.Enabled)
                {
                    ...
                    {
                        p.Key.ButtonColor = _SlowBlinkOn ? p.Value : HMI.Presentation.AUrr.UI.VisualStyle.ButtonColor;
                    }
                }
            }
            catch (Exception ex)
        ...
        {
            bool show = _MemBT.ButtonColor != HMI.Presentation.AUrr.UI.VisualStyle.Colors.Yellow;
