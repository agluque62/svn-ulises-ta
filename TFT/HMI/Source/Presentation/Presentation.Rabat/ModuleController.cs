...
namespace HMI.Presentation.Rabat
{
	public class ModuleController : WorkItemController
	{
		...
		public void OnSwitchTlfViewUI(object sender, EventArgs<string> e)
		{
            ...
            else if (_ActualTlfView == ViewNames.Depencences || _ActualTlfView == ViewNames.Replay || _ActualTlfView == ViewNames.InfoEngine)
            {
                NavigateToPrevius();
            }
		}
