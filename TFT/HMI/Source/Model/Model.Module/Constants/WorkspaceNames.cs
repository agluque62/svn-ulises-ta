...
namespace HMI.Model.Module.Constants
{
	...
	/// </summary>
	public class WorkspaceNames : HMI.Infrastructure.Interface.Constants.WorkspaceNames
	{
		public const string HeaderWorkspace = "HeaderWorkspace";
		public const string RdWorkspace = "RdWorkspace";
		public const string TlfWorkspace = "TlfWorkspace";
		public const string TlfFunctionsWorkspace = "TlfFunctionsWorkspace";
		public const string TlfNumbersWorkspace = "TlfNumbersWorkspace";
		public const string LcWorkspace = "LcWorkspace";
