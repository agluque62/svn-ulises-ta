...
rem echo "SCHTASKS.EXE /CREATE /TN UV5K-HMI-START /F /XML UV5K-HMI-START.XML" >> install.log.txt
rem SCHTASKS.EXE /CREATE /TN "UV5K-HMI-START" /F /XML "UV5K-HMI-START.XML" >> install.log.txt
...
rem echo "SCHTASKS.EXE /CREATE /TN TEAMVIEWER-START /F /XML TEAMVIEWER-START.xml" >> install.log.txt
rem SCHTASKS.EXE /CREATE /TN "TEAMVIEWER-START" /F /XML "TEAMVIEWER-START.xml" >> install.log.txt
