...
echo "SCHTASKS.EXE /CREATE /TN UV5K-WAUDIO-START /F /XML UV5K-WAUDIO-START.XML /RU SYSTEM /RP" >> install.log.txt
SCHTASKS.EXE /CREATE /TN "UV5K-WAUDIO-START" /F /XML "UV5K-WAUDIO-START.XML" /RU SYSTEM /RP >> install.log.txt
